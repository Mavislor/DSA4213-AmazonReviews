...
### Process
1. As our original dataset on Amazon reviews is not labeled for sarcasm, there is a need to use a new dataset to finetune the separate BERT model for sarcasm detection. We will use the `Sarcasm_Headlines_Datset.json` dataset for this purpose. This is done under `01_sarcasm_BERT.ipynb`.
